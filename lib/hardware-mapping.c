...
struct HardwareMapping matrix_hardware_mappings[] = {
     ...
     */
    {
        ...
        .p0_g1 =
            GPIO_BIT(27),     /* Not on RPi1, Rev1; use "regular-pi1" instead */
        ...
        /* All the following are only available with 40 GPIP pins, on
           A+/B+/Pi2,3 */
        /* Chain 1 */
        .p1_r1 = GPIO_BIT(12),
        .p1_g1 = GPIO_BIT(5),
     ...
     */
    {
        ...
        /* Parallel chain 0, RGB for both sub-panels */
        .p0_r1 = GPIO_BIT(11), /* masks: SPI0_SCKL  */
        /* On Pi1 Rev1, the pin other Pis have GPIO27, these have GPIO21. So
         * make this work for both Rev1 and Rev2.
         */
